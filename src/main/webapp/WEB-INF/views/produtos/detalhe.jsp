...
<head>
    <c:url value="/" var="contextPath" />
      <meta charset="utf-8"/>
          ...
          <!-- inject:css -->
			<link rel="stylesheet" href="//cdn.shopify.com/s/files/1/0155/7645/t/188/assets/style.css?589187536880142783">
		  <!-- endinject -->
  ...
  <header id="layout-header">
    ...
    <article id="${produto.id }">
      ...
      <form action="/carrinho/add" method="post" class="container">
        ...
        <button type="submit" class="submit-image icon-basket-alt" alt="Compre Agora" title="${produto.titulo }"></button>
